...
const BOARD_META = {
  ...
  3: { name: '玩家天地', type: 0, tags: ['组队', '开黑', '车队', '招募', '萌新', '抽卡', '求助'] },
...
function main () {
  ...
  const anns = [
    ...
    ['玩家天地发帖指南', '「玩家天地」是玩家向综合区，可以发三类内容：\n\n【晒欧气 / 抽卡】出了好东西欢迎来晒，但请不要在标题剧透新角色剧情；\n【组队招募】建议写清：1. 游戏名称与玩法/模式；2. 上线时间与大概时长；3. 需求人数与位置；4. 平台（手机 / PC / 主机）与是否语音；\n【疑难求助 / 萌新提问】提问时请附上具体信息（游戏版本、报错原文、已尝试的操作），这样更容易被解答。\n\n祝大家都能抽到想要的，也能找到靠谱队友。', 0, 5],
